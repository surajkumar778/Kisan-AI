...
const farmerRoutes    = require('./src/routes/farmerRoutes');   // ✅ NEW
...
app.use(cors({
  ...
  methods: ['GET', 'POST', 'PUT', 'DELETE', 'OPTIONS'],   // ✅ PUT, DELETE add kiya
...
app.use('/api/farmer',  farmerRoutes);                     // ✅ NEW
...
app.listen(PORT, () => {
  ...
  console.log(`║   👨‍🌾  Farmer:   http://localhost:${PORT}/api/farmer║`); // ✅ NEW
